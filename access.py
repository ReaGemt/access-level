...
admin = Admin(1, 'Алексей', '12345') # id пользователя, имя и пароль

# Создаем обычных пользователей
user1 = User(2, 'Ирина', '123') # id пользователя, имя и пароль
user2 = User(3, 'Пётр', '456') # id пользователя, имя и пароль
